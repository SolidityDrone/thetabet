...
export const thetaSingletonAbi = [
        ...
        components: [
          { name: 'betOwner', type: 'address' },
          {
            ...
            components: [
              ...
              { name: 'outcomes', type: 'uint128[]' },
              { name: 'potentialLossLimit', type: 'uint128' },
              { name: 'winningOutcomesCount', type: 'uint8' },
            ],
          },
          { name: 'betType', type: 'uint8' },
          { name: 'oracle', type: 'address' },
          { name: 'clientBetData', type: 'bytes' },
          { name: 'bettorSignature', type: 'bytes' },
  ...
  {
    type: 'function',
    name: 'cancelVaultBetPreparation',
    inputs: [{ name: 'vaultId', type: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  {
    type: 'function',
    name: 'pendingVaultBets',
    inputs: [{ name: 'vaultId', type: 'uint256' }],
    outputs: [
      { name: 'tipster', type: 'address' },
      { name: 'stake', type: 'uint128' },
      { name: 'relayerFee', type: 'uint128' },
      { name: 'orderHash', type: 'bytes32' },
      { name: 'expiresAt', type: 'uint64' },
  ...
  {
    type: 'function',
    name: 'completeVaultBet',
    inputs: [
      { name: 'vaultId', type: 'uint256' },
      { name: 'core', type: 'address' },
      { name: 'azuroTokenId', type: 'uint256' },
      { name: 'conditionId', type: 'uint256' },
